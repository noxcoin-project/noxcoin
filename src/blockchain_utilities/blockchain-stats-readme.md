# Noxcoin Blockchain Stats

Noxcoin Blockchain Stats utlity exports daily statistics for the noxcoin blockchain from creation through current state.

## Usage:

See also the utility's help option. `noxcoin-blockchain-stats --help`
...
- `noxcoin-blockchain-stats > stats-$(date +'%Y-%m-%d').csv`
- `noxcoin-blockchain-stats | save-to-database.sh`
